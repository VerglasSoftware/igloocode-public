	...
	return (
		<Layout>
			...
			<section
				...
				id="hero">
				<h1 className="font-mono w-fit text-transparent text-7xl font-bold bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-400 pb-3">Join the team</h1>
				<p className="font-mono text-white text-3xl">{"< think you have what it takes? />"}</p>
			</section>
					...
					<div id="about">
						<div className="grid grid-cols-3 gap-12">
							...
							<div className="flex justify-center items-center">
								<img src={imgSam} className="w-full h-[22rem] shadow-md object-cover my-3" alt="Team member" />
							</div>
						</div>
						<div className="grid grid-cols-3 gap-12 mt-12">
							<div className="flex justify-center items-center">
								<img src={imgKaty} className="w-full h-[24rem] shadow-md object-cover my-3" alt="Team member" />
							</div>
							<div className="flex flex-col justify-center col-span-2">
								<h2 className="font-mono text-white text-4xl font-medium">
			...
			<section className="bg-hero bg-cover bg-sat flex items-center flex-col">
				<div className="py-16 w-9/12 max-w-screen-lg flex items-center justify-center flex-col">
					...
					<Link to="/about" className="font-mono text-white hover:underline text-xl mt-4 border-[1px] border-gray-400 p-2 w-1/3 text-center">
						READ THE STORY
					</Link>
				</div>
			</section>
						...
						<div className="grid grid-cols-2 gap-12">
							<div className="flex flex-col justify-center items-center">
								...
								<div className="flex flex-row items-center justify-center mt-3">
									...
									<div>
										<p className="font-mono text-white text-lg">Volunteering experience</p>
										<p className="font-mono text-gray-400 text-sm">Learn what it's like to help keep a pretty big, fast-paced event running smoothly.</p>
									</div>
								</div>
								<div className="flex flex-row items-center justify-center mt-3">
									<div className="bg-[#111113] w-16 h-16 flex items-center justify-center rounded-full mr-5 flex-none">
									...
									<div>
										<p className="font-mono text-white text-lg">Industry links</p>
								...
								<div className="flex flex-row items-center justify-center mt-3">
									...
									<div>
										<p className="font-mono text-white text-lg">Something for UCAS</p>
										<p className="font-mono text-gray-400 text-sm">A fun day out and something to stick on your uni applications... what's not to lose?</p>
									</div>
								</div>
								<div className="flex flex-row items-center justify-center mt-4">
									...
									<div>
										<p className="font-mono text-white text-lg">Free food!</p>
										<p className="font-mono text-gray-400 text-sm">Grab some pizza and boba with us, or whatever else we choose to Deliveroo on the day.</p>
									</div>
								</div>
							</div>
							<div className="flex justify-center items-center">
								<img src={imgQueens} className="w-full h-[35rem] shadow-md object-cover" alt="Event venue" />
							</div>
						</div>
						<div className="grid grid-cols-2 gap-12 mt-16">
							<div className="flex justify-center items-center">
								<img src={imgMacSB} className="w-full h-[37rem] shadow-md object-cover my-3" alt="Team member" />
							</div>
							<div className="flex flex-col justify-center">
								...
								<div className="flex flex-row items-center justify-center mt-4">
									<div className="bg-[#111113] w-16 h-16 flex items-center justify-center rounded-full mr-5 flex-none">
										<span className="font-mono text-sky-400 text-2xl font-medium">1</span>
									</div>
									<div>
								...
								<div className="flex flex-row items-center justify-center mt-4">
									<div className="bg-[#111113] w-16 h-16 flex items-center justify-center rounded-full mr-5 flex-none">
										<span className="font-mono text-purple-400 text-2xl font-medium">2</span>
									</div>
									<div>
										<p className="font-mono text-gray-300 text-sm">
								...
								<div className="flex flex-row items-center justify-center mt-4">
									<div className="bg-[#111113] w-16 h-16 flex items-center justify-center rounded-full mr-5 flex-none">
										<span className="font-mono text-sky-400 text-2xl font-medium">3</span>
									</div>
									<div>
										<p className="font-mono text-gray-300 text-sm">
											Fill in the application form at <Link to="/f/volunteer" className="font-bold underline">https://iglooco.de/f/volunteer</Link> and submit it before December 21st.
										</p>
									</div>
								</div>
								<div className="flex flex-row items-center justify-center mt-4">
									<div className="bg-[#111113] w-16 h-16 flex items-center justify-center rounded-full mr-5 flex-none">
										<span className="font-mono text-purple-400 text-2xl font-medium">4</span>
									</div>
									<div>
										<p className="font-mono text-gray-300 text-sm">
								...
								<p className="font-mono text-white text-md font-thin pt-4">
